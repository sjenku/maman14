myProg: main.o leacks_cheker_ex.o symbolList.o tools.o inputHandler.o asmbOperation.o queue.o engineCompile.o
	gcc -Wall -ansi -pedantic -g main.o leacks_cheker_ex.o symbolList.o tools.o inputHandler.o asmbOperation.o queue.o engineCompile.o -o myProg
